...
const opcodes = { add: 0x05, addRegRm: 0x03, orRegRm8: 0x0a, orAlImm8: 0x0c, andAlImm8: 0x24, xor: 0x35, csOverride: 0x2e, subRegRm: 0x2b, xorRmReg: 0x31, xorRegRm8: 0x32, xorRegRm: 0x33, sub: 0x2d, cmpRm8Reg: 0x38, groupRm8Imm: 0x80, jb: 0x72, jbe: 0x76, xchgRmReg: 0x87, movRm8Reg: 0x88, movRegRm8: 0x8a, movRmReg: 0x89, movRegRm: 0x8b, movSreg: 0x8e, movAlMoffs8: 0xa0, store: 0xa3, movsb: 0xa4, lds: 0xc5, movRm8Imm: 0xc6, rolRm8Imm: 0xc0, shlRm8One: 0xd0, rep: 0xf3, jz: 0x74, jnz: 0x75, jl: 0x7c, retfImm: 0xca, intImm: 0xcd, loop: 0xe2, call: 0xe8, testRm8Imm: 0xf6, decRm8: 0xfe, callRm16: 0xff, outDxAl: 0xee, jmpShort: 0xeb, jmp: 0xe9, far: 0xea, ret: 0xc3, pushf: 0x9c, popf: 0x9d, clc: 0xf8, stc: 0xf9, cli: 0xfa, sti: 0xfb, cld: 0xfc, hlt: 0xf4 };
...
signal['test-rm8-immediate-read'] = andBit(ref('opcode-testRm8Imm'), ref('phase-memory-read-low'));
signal['group-rm8-immediate-read'] = andBit(ref('opcode-group-rm8-immediate-memory'), ref('phase-memory-read-low'));
signal['byte-immediate-memory-op'] = orBit(ref('opcode-testRm8Imm'), ref('opcode-group-rm8-immediate-memory'));
...
signal['instruction-read'] = anyBits([
  ref('phase-opcode'), andBit(ref('phase-imm-low'), notBit(ref('opcode-outDxAl'))), ref('phase-imm-high'), ref('mov-rm8-immediate-read'), ref('test-rm8-immediate-read'), ref('group-rm8-immediate-read'),
  andBit(notBit(ref('opcode-intImm')), anyBits([
    andBit(notBit(ref('opcode-retfImm')), orBit(ref('phase-far-low'), ref('phase-far-high'))),
...
signal['stack-read'] = andBit(notBit(ref('opcode-intImm')), anyBits([
  ...
  andBit(ref('opcode-retfImm'), orBit(ref('phase-far-low'), ref('phase-far-high'))),
]));
signal['memory-read'] = andBit(andBit(notBit(ref('opcode-movRm8Imm')), notBit(ref('opcode-intImm'))), anyBits([
...
signal['opcode-byte-memory-write'] = orBit(ref('opcode-mov-rm8'), ref('opcode-group-rm8-immediate-memory'));
signal['word-memory-write'] = andBit(andBit(andBit(notBit(ref('opcode-lds')), notBit(ref('opcode-movsb'))), notBit(ref('opcode-byte-memory-write'))), ref('memory-final-pair'));
...
signal['read-phase'] = anyBits([ref('instruction-read'), ref('stack-read'), ref('memory-read'), ref('lds-extra-read'), ref('movsb-read'), ref('int-vector-read')]);
...
signal['fetched-short'] = anyBits([ref('fetched-jb'), ref('fetched-jz'), ref('fetched-jnz'), ref('fetched-jbe'), ref('fetched-jl'), ref('fetched-jmpShort'), ref('fetched-loop')]);
signal['opcode-short'] = anyBits([ref('opcode-jb'), ref('opcode-jz'), ref('opcode-jnz'), ref('opcode-jbe'), ref('opcode-jl'), ref('opcode-jmpShort'), ref('opcode-loop')]);
signal['fetched-modrm'] = anyBits([ref('fetched-addRegRm'), ref('fetched-subRegRm'), ref('fetched-movRm8Reg'), ref('fetched-movRmReg'), ref('fetched-movRegRm'), ref('fetched-xorRmReg'), ref('fetched-orRegRm8'), ref('fetched-xorRegRm8'), ref('fetched-xorRegRm'), ref('fetched-cmpRm8Reg'), ref('fetched-groupRm8Imm'), ref('fetched-xchgRmReg'), ref('fetched-movRegRm8'), ref('fetched-movSreg'), ref('fetched-lds'), ref('fetched-movRm8Imm'), ref('fetched-shlRm8One'), ref('fetched-rolRm8Imm'), ref('fetched-decRm8'), ref('fetched-callRm16'), ref('fetched-testRm8Imm')]);
signal['opcode-modrm'] = anyBits([ref('opcode-addRegRm'), ref('opcode-subRegRm'), ref('opcode-movRm8Reg'), ref('opcode-movRmReg'), ref('opcode-movRegRm'), ref('opcode-xorRmReg'), ref('opcode-orRegRm8'), ref('opcode-xorRegRm8'), ref('opcode-xorRegRm'), ref('opcode-cmpRm8Reg'), ref('opcode-groupRm8Imm'), ref('opcode-xchgRmReg'), ref('opcode-movRegRm8'), ref('opcode-movSreg'), ref('opcode-lds'), ref('opcode-movRm8Imm'), ref('opcode-shlRm8One'), ref('opcode-rolRm8Imm'), ref('opcode-decRm8'), ref('opcode-callRm16'), ref('opcode-testRm8Imm')]);
...
signal['fetched-simple'] = anyBits([ref('fetched-if-control'), ref('fetched-clc'), ref('fetched-stc'), ref('fetched-cld')]);
...
signal['opcode-memory-supported'] = anyBits([ref('opcode-movRm8Reg'), ref('opcode-movRegRm8'), ref('opcode-movRmReg'), ref('opcode-movRegRm'), ref('opcode-xorRmReg'), ref('opcode-xorRegRm8'), ref('opcode-xorRegRm'), ref('opcode-cmpRm8Reg'), ref('opcode-movSreg'), ref('opcode-lds'), ref('opcode-movRm8Imm'), ref('opcode-callRm16'), ref('opcode-testRm8Imm'), ref('opcode-groupRm8Imm')]);
...
signal['modrm-gpr-commit'] = andBit(ref('modrm-commit'), andBit(andBit(andBit(notBit(ref('opcode-movSreg')), notBit(ref('opcode-lds'))), notBit(ref('opcode-mov-rm8'))), notBit(anyBits([ref('opcode-cmpRm8Reg'), ref('opcode-groupRm8Imm'), ref('opcode-movRegRm8'), ref('opcode-orRegRm8'), ref('opcode-xorRegRm8'), ref('opcode-shlRm8One'), ref('opcode-rolRm8Imm'), ref('opcode-decRm8'), ref('opcode-callRm16'), ref('opcode-testRm8Imm'), ref('opcode-xchgRmReg')]))));
...
signal['test-rm8-form-valid'] = orBit(notBit(ref('opcode-testRm8Imm')), ref('test-rm8-immediate-selector-valid'));
...
signal['dec-rm8-selector-invalid'] = andBit(ref('capture-modrm'), andBit(ref('opcode-decRm8'), notBit(ref('dec-rm8-selector-valid'))));
signal['test-rm8-immediate-selector-invalid'] = andBit(ref('capture-modrm'), andBit(ref('opcode-testRm8Imm'), notBit(ref('test-rm8-immediate-selector-valid'))));
signal['test-rm8-immediate-register-invalid'] = andBit(ref('modrm-commit'), ref('opcode-testRm8Imm'));
signal['modrm-invalid'] = anyBits([ref('modrm-address-invalid'), ref('mov-sreg-selector-invalid'), ref('lds-register-invalid'), ref('mov-rm8-selector-invalid'), ref('group-rm8-immediate-selector-invalid'), ref('shl-rm8-one-selector-invalid'), ref('call-rm16-selector-invalid'), ref('call-rm16-register-invalid'), ref('rol-rm8-immediate-selector-invalid'), ref('dec-rm8-selector-invalid'), ref('test-rm8-immediate-selector-invalid'), ref('test-rm8-immediate-register-invalid')]);
...
signal['execute-test-rm8-immediate-memory'] = andBit(ref('capture-memory-high'), ref('opcode-testRm8Imm'));
...
signal['execute-dec-rm8-register'] = andBit(ref('modrm-commit'), andBit(ref('opcode-decRm8'), ref('dec-rm8-selector-valid')));
...
signal['update-carry-control'] = orBit(ref('update-clc'), ref('update-stc'));
...
signal['next-if'] = muxBit(ref('finish-popf'), ref('interrupt-if'), ref('busData-1'));
signal['interrupt-tf'] = muxBit(ref('finish-int-flags'), ref('tf'), lit(0));
signal['next-tf'] = muxBit(ref('finish-popf'), ref('interrupt-tf'), ref('busData-0'));
signal['next-nt'] = muxBit(ref('finish-popf'), ref('nt'), ref('busData-6'));
for (let index = 0; index < 2; index++) signal[`next-iopl-${index}`] = muxBit(ref('finish-popf'), ref(`iopl-${index}`), ref(`busData-${index + 4}`));
signal['update-df'] = andBit(ref('capture-opcode'), ref('fetched-cld'));
signal['controlled-df'] = muxBit(ref('update-df'), ref('df'), lit(0));
signal['next-df'] = muxBit(ref('finish-popf'), ref('controlled-df'), ref('busData-2'));
...
signal['clear-cs-override'] = anyBits([
  ...
  andBit(ref('capture-memory-high'), anyBits([ref('opcode-movRegRm'), ref('opcode-xorRegRm'), ref('opcode-movSreg'), ref('opcode-callRm16'), ref('opcode-testRm8Imm')])),
...
signal['continue-immediate'] = andBit(ref('capture-imm-low'), andBit(notBit(anyBits([ref('opcode-short'), ref('opcode-mov8'), ref('opcode-movRm8Imm'), ref('opcode-groupRm8Imm'), ref('opcode-al-logical-immediate'), ref('opcode-rolRm8Imm')])), notBit(ref('opcode-intImm'))));
...
signal['test-rm8-immediate-start'] = andBit(ref('memory-operand-ready'), ref('opcode-testRm8Imm'));
...
signal['byte-rmw-start-write'] = andBit(ref('capture-memory-high'), ref('opcode-group-rm8-immediate-memory'));
signal['lds-continue-read'] = andBit(ref('capture-memory-high'), ref('opcode-lds'));
const phaseRoutes = [
  [1, anyBits([ref('begin-immediate'), ref('begin-out'), ref('begin-mov-rm8-register'), ref('begin-sub-rm8-immediate-register'), ref('begin-cmp-rm8-immediate-register'), ref('begin-rol-rm8-immediate-register')])], [2, ref('continue-immediate')], [3, orBit(ref('begin-write'), ref('begin-int'))], [4, ref('phase-write-low')],
  [5, anyBits([ref('begin-stack-read'), ref('begin-retf'), andBit(ref('opcode-intImm'), ref('phase-write-high'))])], [6, ref('phase-ret-low')], [7, anyBits([ref('begin-far'), andBit(ref('opcode-retfImm'), ref('phase-ret-high')), andBit(ref('opcode-intImm'), ref('phase-ret-high'))])], [8, ref('phase-far-low')], [9, orBit(ref('begin-modrm'), andBit(ref('opcode-intImm'), ref('phase-far-high')))],
  ...
  [12, anyBits([ref('memory-start-read'), ref('mov-rm8-immediate-start'), ref('test-rm8-immediate-start'), ref('group-rm8-immediate-start'), ref('begin-mov-al-moffs8'), andBit(ref('opcode-intImm'), ref('phase-disp-high'))])], [13, anyBits([ref('test-rm8-operand-start'), ref('group-rm8-operand-start'), andBit(ref('capture-memory-low'), notBit(anyBits([ref('opcode-cmpRm8Reg'), ref('opcode-movRegRm8'), ref('opcode-xorRegRm8'), ref('opcode-movAlMoffs8')])) )])],
  [14, anyBits([ref('memory-start-write'), ref('memory-rmw-start-write'), ref('byte-rmw-start-write'), ref('lds-continue-read'), ref('begin-movsb'), ref('repeat-movsb'), ref('mov-rm8-write-start')])], [15, andBit(ref('phase-memory-write-low'), notBit(ref('opcode-byte-memory-write')))],
];
...
for (let index = 0; index < 8; index++) {
  ...
  const byteMemoryWriteData = muxBit(ref('opcode-group-rm8-immediate-memory'), byteRegisterWriteData, ref(`group-rm8-immediate-result-${index}`));
...
signal['short-condition'] = anyBits([ref('opcode-jmpShort'), andBit(ref('opcode-jb'), ref('cf')), andBit(ref('opcode-jz'), ref('zf')), andBit(ref('opcode-jbe'), orBit(ref('cf'), ref('zf'))), andBit(ref('opcode-jnz'), notBit(ref('zf'))), andBit(ref('opcode-jl'), xorBit(ref('sf'), ref('of'))), andBit(ref('opcode-loop'), ref('cx-dec-nonzero'))]);
...
for (let index = 0; index < WIDTH; index++) {
  ...
  signal[`next-cs-${index}`] = muxBit(ref('finish-int'), ref(`far-cs-${index}`), ref(`int-segment-${index}`));
}
...
signal['cmp-commit'] = anyBits([ref('cmp-register-commit'), ref('group-rm8-immediate-register-commit'), ref('cmp-memory-commit')]);
...
for (let index = 0; index < 8; index++) {
  ...
  signal[`cmp-register-destination-${index}`] = muxBit(ref('group-rm8-immediate-register-commit'), ref(`modrm-rm-byte-register-value-${index}`), ref(`saved-modrm-rm-byte-register-value-${index}`));
  signal[`cmp-register-source-${index}`] = muxBit(ref('group-rm8-immediate-register-commit'), ref(`modrm-byte-register-value-${index}`), ref(`busData-${index}`));
...
for (const register of registers) {
  ...
  signal[`write-${register}`] = anyBits([ref(`write-immediate-${register}`), ref(`write-modrm-${register}`), ref(`write-memory-${register}`), ref(`write-pop-${register}`), ref(`write-xchg-${register}`)]);
  for (let index = 0; index < WIDTH; index++) {
    ...
    const xchgOrImmediateSource = muxBit(ref(`write-xchg-${register}`), immediateSource, xchgSource);
    ...
    if (byteRegister) {
      ...
      const writeModrmByte = anyBits([writeImmediateModrmByte, writeSubRm8Immediate, writeRegisterModrmByte, writeRegisterFromRmByte, writeMemoryToRegisterByte, writeByteLogicalRm8, writeDecRm8, writeShlRm8, writeRolRm8]);
      ...
      const subtractSource = muxBit(writeSubRm8Immediate, rotateSource, ref(`cmp-result-${index % 8}`));
      const decrementSource = muxBit(writeDecRm8, subtractSource, ref(`dec-rm8-result-${index % 8}`));
      const byteSource = muxBit(writeAlLogical, decrementSource, ref(`al-logical-result-${index % 8}`));
...
for (let index = 0; index < WIDTH; index++) {
  ...
  signal[`next-sp-${index}`] = muxBit(ref('write-pop-sp'), returnedFarSp, ref(`next-base-sp-${index}`));
...
signal['update-flags'] = anyBits([andBit(ref('execute'), anyBits([ref('opcode-add'), ref('opcode-sub'), ref('opcode-xor')])), andBit(ref('modrm-gpr-commit'), ref('opcode-modrm-xor')), ref('modrm-add-commit'), ref('modrm-sub-commit'), ref('memory-flag-commit'), ref('cmp-commit'), ref('execute-byte-logical-rm8'), ref('execute-dec-rm8-register'), ref('execute-shl-rm8-one-register'), ref('execute-al-logical-immediate'), ref('execute-test-rm8-immediate-memory'), ref('group-rm8-immediate-memory-commit')]);
for (const flag of ['cf', 'pf', 'af', 'zf', 'sf', 'of']) {
  ...
  const testFlag = muxBit(ref('execute-test-rm8-immediate-memory'), decFlag, ref(`test-rm8-immediate-${flag}`));
  const groupImmediateFlag = muxBit(ref('group-rm8-immediate-memory-commit'), testFlag, ref(`group-rm8-immediate-${flag}`));
  signal[`selected-${flag}`] = muxBit(ref('cmp-commit'), groupImmediateFlag, ref(`cmp-${flag}`));
  signal[`next-base-${flag}`] = muxBit(ref('update-flags'), ref(flag), ref(`selected-${flag}`));
  const popfSource = ['cf', 'pf', 'af', 'zf', 'sf'].includes(flag) ? ref(`stackLow-${{ cf: 0, pf: 2, af: 4, zf: 6, sf: 7 }[flag]}`) : ref('busData-3');
  signal[`next-${flag}`] = muxBit(ref('finish-popf'), ref(`next-base-${flag}`), popfSource);
}
signal['next-rol-cf'] = muxBit(ref('rol-rm8-count-nonzero'), ref('next-base-cf'), ref('rol-rm8-result-0'));
signal['controlled-cf'] = muxBit(ref('update-carry-control'), ref('next-rol-cf'), ref('update-stc'));
signal['next-cf'] = muxBit(ref('finish-popf'), ref('controlled-cf'), ref('stackLow-0'));
signal['rotated-of'] = muxBit(ref('rol-rm8-count-one'), ref('next-base-of'), xorBit(ref('rol-rm8-result-7'), ref('rol-rm8-result-0')));
signal['next-of'] = muxBit(ref('finish-popf'), ref('rotated-of'), ref('busData-3'));
