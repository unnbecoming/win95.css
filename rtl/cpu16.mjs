...
signal['group-rm8-immediate-read'] = andBit(ref('opcode-group-rm8-immediate-memory-form'), ref('phase-memory-read-low'));
signal['byte-immediate-memory-op'] = orBit(ref('opcode-test-rm8-immediate'), ref('opcode-group-rm8-immediate-memory-form'));
...
signal['stosb-write'] = andBit(ref('opcode-stosb'), ref('phase-memory-write-low'));
signal['stosw-write-low'] = andBit(ref('opcode-stosw'), ref('phase-memory-write-low'));
signal['stosw-write-high'] = andBit(ref('opcode-stosw'), ref('phase-memory-write-high'));
signal['stosw-write'] = orBit(ref('stosw-write-low'), ref('stosw-write-high'));
...
signal['word-memory-write'] = andBit(andBit(andBit(andBit(andBit(andBit(andBit(notBit(ref('opcode-lds')), notBit(ref('opcode-movsb'))), notBit(ref('opcode-stosb'))), notBit(ref('opcode-stosw'))), notBit(ref('opcode-lodsb'))), notBit(ref('opcode-lodsw'))), notBit(ref('opcode-byte-memory-write'))), ref('memory-final-pair'));
...
signal['write-phase'] = anyBits([ref('phase-write-low'), ref('phase-write-high'), ref('memory-write'), ref('movsb-write'), ref('stosb-write'), ref('stosw-write'), ref('int-stack-write')]);
...
signal['fetched-short'] = anyBits([ref('fetched-jb'), ref('fetched-jz'), ref('fetched-jnz'), ref('fetched-jbe'), ref('fetched-ja'), ref('fetched-jl'), ref('fetched-jmpShort'), ref('fetched-loop'), ref('fetched-jcxz')]);
signal['opcode-short'] = anyBits([ref('opcode-jb'), ref('opcode-jz'), ref('opcode-jnz'), ref('opcode-jbe'), ref('opcode-ja'), ref('opcode-jl'), ref('opcode-jmpShort'), ref('opcode-loop'), ref('opcode-jcxz')]);
signal['fetched-modrm'] = anyBits([ref('fetched-addRm8Reg'), ref('fetched-addRegRm'), ref('fetched-subRegRm8'), ref('fetched-subRegRm'), ref('fetched-movRm8Reg'), ref('fetched-movRmReg'), ref('fetched-movRegRm'), ref('fetched-xorRmReg'), ref('fetched-orRegRm8'), ref('fetched-xorRegRm8'), ref('fetched-xorRegRm'), ref('fetched-cmpRm8Reg'), ref('fetched-cmpRegRm8'), ref('fetched-cmpRegRm'), ref('fetched-groupRm8Imm'), ref('fetched-groupRm16Imm'), ref('fetched-groupRm16Imm8'), ref('fetched-testRm8Reg'), ref('fetched-xchgRm8Reg'), ref('fetched-xchgRmReg'), ref('fetched-movRegRm8'), ref('fetched-lea'), ref('fetched-movSreg'), ref('fetched-lds'), ref('fetched-movRm8Imm'), ref('fetched-shlRm8One'), ref('fetched-shlRm16One'), ref('fetched-rolRm8Imm'), ref('fetched-rolRm8Cl'), ref('fetched-incDecRm8'), ref('fetched-callRm16'), ref('fetched-testRm8Imm')]);
signal['opcode-modrm'] = anyBits([ref('opcode-lea'), ref('opcode-addRm8Reg'), ref('opcode-addRegRm'), ref('opcode-subRegRm8'), ref('opcode-subRegRm'), ref('opcode-movRm8Reg'), ref('opcode-movRmReg'), ref('opcode-movRegRm'), ref('opcode-xorRmReg'), ref('opcode-orRegRm8'), ref('opcode-xorRegRm8'), ref('opcode-xorRegRm'), ref('opcode-cmpRm8Reg'), ref('opcode-cmpRegRm8'), ref('opcode-cmpRegRm'), ref('opcode-groupRm8Imm'), ref('opcode-groupRm16Imm'), ref('opcode-groupRm16Imm8'), ref('opcode-testRm8Reg'), ref('opcode-xchgRm8Reg'), ref('opcode-xchgRmReg'), ref('opcode-movRegRm8'), ref('opcode-movSreg'), ref('opcode-lds'), ref('opcode-movRm8Imm'), ref('opcode-shlRm8One'), ref('opcode-shlRm16One'), ref('opcode-rolRm8Imm'), ref('opcode-rolRm8Cl'), ref('opcode-incDecRm8'), ref('opcode-callRm16'), ref('opcode-testRm8Imm')]);
signal['opcode-modrm-to-reg'] = anyBits([ref('opcode-addRegRm'), ref('opcode-subRegRm'), ref('opcode-cmpRegRm'), ref('opcode-movRegRm'), ref('opcode-xorRegRm')]);
...
signal['fetched-string'] = anyBits([ref('fetched-movsb'), ref('fetched-stosb'), ref('fetched-stosw'), ref('fetched-lodsb'), ref('fetched-lodsw')]);
...
signal['rep-target-invalid'] = andBit(ref('rep'), notBit(anyBits([ref('fetched-rep'), ref('fetched-csOverride'), ref('fetched-movsb'), ref('fetched-stosb'), ref('fetched-stosw')])));
...
signal['finish-stosb'] = andBit(ref('stosb-write'), ref('bus-write'));
signal['finish-stosw'] = andBit(ref('stosw-write-high'), ref('bus-write'));
...
signal['group-rm8-immediate-memory-selector-valid'] = anyBits([ref('or-rm8-immediate-selector-valid'), ref('and-rm8-immediate-selector-valid'), ref('cmp-rm8-immediate-selector-valid')]);
signal['group-rm8-immediate-register-selector-valid'] = anyBits([ref('and-rm8-immediate-selector-valid'), ref('sub-rm8-immediate-selector-valid'), ref('cmp-rm8-immediate-selector-valid')]);
...
signal['saved-group-rm8-immediate-memory-selector-valid'] = anyBits([ref('saved-or-rm8-immediate-selector-valid'), ref('saved-and-rm8-immediate-selector-valid'), ref('saved-cmp-rm8-immediate-selector-valid')]);
...
signal['opcode-cmp-rm8-immediate-memory'] = andBit(ref('opcode-groupRm8Imm'), ref('saved-cmp-rm8-immediate-selector-valid'));
signal['opcode-group-rm8-immediate-memory'] = orBit(ref('opcode-or-rm8-immediate-memory'), ref('opcode-and-rm8-immediate-memory'));
signal['opcode-group-rm8-immediate-memory-form'] = orBit(ref('opcode-group-rm8-immediate-memory'), ref('opcode-cmp-rm8-immediate-memory'));
...
signal['modrm-gpr-commit'] = andBit(ref('modrm-commit'), andBit(andBit(andBit(notBit(ref('opcode-movSreg')), notBit(ref('opcode-lds'))), notBit(ref('opcode-mov-rm8'))), notBit(anyBits([ref('opcode-lea'), ref('opcode-addRm8Reg'), ref('opcode-cmpRm8Reg'), ref('opcode-cmpRegRm8'), ref('opcode-cmpRegRm'), ref('opcode-groupRm8Imm'), ref('opcode-groupRm16Imm'), ref('opcode-groupRm16Imm8'), ref('opcode-testRm8Reg'), ref('opcode-movRegRm8'), ref('opcode-orRegRm8'), ref('opcode-xorRegRm8'), ref('opcode-shlRm8One'), ref('opcode-shlRm16One'), ref('opcode-rolRm8Imm'), ref('opcode-rolRm8Cl'), ref('opcode-incDecRm8'), ref('opcode-callRm16'), ref('opcode-testRm8Imm'), ref('opcode-xchgRm8Reg'), ref('opcode-xchgRmReg'), ref('opcode-subRegRm8')]))));
...
signal['lock-cmp-rm8-immediate-memory-invalid'] = andBit(ref('capture-modrm'), andBit(ref('lock'), andBit(ref('opcode-groupRm8Imm'), andBit(notBit(ref('modrm-register')), ref('cmp-rm8-immediate-selector-valid')))));
...
signal['rol-rm8-cl-selector-invalid'] = andBit(ref('capture-modrm'), andBit(ref('opcode-rolRm8Cl'), notBit(ref('rol-rm8-immediate-selector-valid'))));
...
signal['modrm-invalid'] = anyBits([ref('modrm-address-invalid'), ref('mov-sreg-selector-invalid'), ref('lds-register-invalid'), ref('lea-register-invalid'), ref('lock-register-invalid'), ref('lock-cmp-rm8-immediate-memory-invalid'), ref('mov-rm8-selector-invalid'), ref('group-rm8-immediate-selector-invalid'), ref('group-rm16-immediate-invalid'), ref('group-rm16-immediate8-invalid'), ref('shl-rm8-one-selector-invalid'), ref('shl-rm16-one-selector-invalid'), ref('call-rm16-selector-invalid'), ref('call-rm16-register-invalid'), ref('rol-rm8-immediate-selector-invalid'), ref('rol-rm8-cl-selector-invalid'), ref('inc-dec-rm8-selector-invalid'), ref('test-rm8-immediate-selector-invalid'), ref('test-rm8-immediate-register-invalid')]);
...
signal['begin-and-rm8-immediate-register'] = andBit(ref('modrm-commit'), andBit(ref('opcode-groupRm8Imm'), ref('and-rm8-immediate-selector-valid')));
...
signal['execute-and-rm8-immediate-register'] = andBit(ref('capture-imm-low'), andBit(ref('opcode-groupRm8Imm'), ref('saved-and-rm8-immediate-selector-valid')));
...
signal['execute-cmp-rm8-immediate-memory'] = andBit(ref('capture-memory-high'), ref('opcode-cmp-rm8-immediate-memory'));
...
signal['execute-rol-rm8-cl-register'] = andBit(ref('modrm-commit'), andBit(ref('opcode-rolRm8Cl'), ref('rol-rm8-immediate-selector-valid')));
signal['execute-rol-rm8-register'] = orBit(ref('execute-rol-rm8-immediate-register'), ref('execute-rol-rm8-cl-register'));
for (let index = 0; index < 5; index++) signal[`rol-rm8-count-${index}`] = muxBit(ref('execute-rol-rm8-cl-register'), ref(`busData-${index}`), ref(`cx-${index}`));
signal['rol-rm8-count-nonzero'] = andBit(ref('execute-rol-rm8-register'), anyBits(signalBits('rol-rm8-count', 5)));
signal['rol-rm8-count-one'] = andBit(ref('execute-rol-rm8-register'), equalConstant('rol-rm8-count', 5, 1));
...
signal['clear-cs-override'] = anyBits([
  ...
  andBit(ref('capture-memory-high'), anyBits([ref('opcode-movRegRm'), ref('opcode-xorRegRm'), ref('opcode-addRegRm'), ref('opcode-cmpRegRm'), ref('opcode-movSreg'), ref('opcode-callRm16'), ref('opcode-test-rm8-immediate'), ref('opcode-cmp-rm8-immediate-memory')])),
...
signal['begin-stosb'] = andBit(andBit(ref('capture-opcode'), ref('fetched-stosb')), orBit(notBit(ref('rep')), ref('cx-nonzero')));
signal['begin-stosw'] = andBit(andBit(ref('capture-opcode'), ref('fetched-stosw')), orBit(notBit(ref('rep')), ref('cx-nonzero')));
...
signal['skip-rep-stosb'] = andBit(andBit(ref('capture-opcode'), ref('fetched-stosb')), andBit(ref('rep'), notBit(ref('cx-nonzero'))));
signal['skip-rep-stosw'] = andBit(andBit(ref('capture-opcode'), ref('fetched-stosw')), andBit(ref('rep'), notBit(ref('cx-nonzero'))));
signal['repeat-movsb'] = andBit(andBit(ref('finish-movsb'), ref('rep')), ref('cx-dec-nonzero'));
signal['repeat-stosb'] = andBit(andBit(ref('finish-stosb'), ref('rep')), ref('cx-dec-nonzero'));
signal['repeat-stosw'] = andBit(andBit(ref('finish-stosw'), ref('rep')), ref('cx-dec-nonzero'));
signal['clear-rep'] = anyBits([ref('skip-rep-movsb'), ref('skip-rep-stosb'), ref('skip-rep-stosw'), andBit(ref('finish-movsb'), notBit(ref('repeat-movsb'))), andBit(ref('finish-stosb'), notBit(ref('repeat-stosb'))), andBit(ref('finish-stosw'), notBit(ref('repeat-stosw')))]);
...
const phaseRoutes = [
  [1, anyBits([ref('begin-immediate'), ref('begin-io'), ref('begin-mov-rm8-register'), ref('begin-and-rm8-immediate-register'), ref('begin-sub-rm8-immediate-register'), ref('begin-cmp-rm8-immediate-register'), ref('begin-and-rm16-immediate-register'), ref('begin-group-rm16-immediate8-register'), ref('begin-rol-rm8-immediate-register')])], [2, ref('continue-immediate')], [3, orBit(ref('begin-write'), ref('begin-int'))], [4, ref('phase-write-low')],
  ...
  [14, anyBits([ref('memory-start-write'), ref('memory-rmw-start-write'), ref('byte-rmw-start-write'), ref('lds-continue-read'), ref('begin-movsb'), ref('begin-stosb'), ref('begin-stosw'), ref('begin-lodsb'), ref('begin-lodsw'), ref('repeat-movsb'), ref('repeat-stosb'), ref('repeat-stosw'), ref('mov-rm8-write-start')])], [15, andBit(ref('phase-memory-write-low'), notBit(anyBits([ref('opcode-byte-memory-write'), ref('opcode-lodsb'), ref('opcode-stosb')])) )],
];
...
signal['di-word-inc-carry-0'] = lit(0);
signal['di-word-dec-carry-0'] = lit(0);
...
for (let index = 0; index < WIDTH; index++) {
  ...
  const diWordIncAddend = lit(index === 1 ? 1 : 0);
  signal[`di-word-inc-sum-${index}`] = add(ref(`di-${index}`), diWordIncAddend);
  signal[`di-word-inc-${index}`] = mod(add(ref(`di-word-inc-sum-${index}`), ref(`di-word-inc-carry-${index}`)), lit(2));
  signal[`di-word-inc-carry-${index + 1}`] = floor(div(add(ref(`di-word-inc-sum-${index}`), ref(`di-word-inc-carry-${index}`)), lit(2)));
  const diWordDecAddend = lit(index === 0 ? 0 : 1);
  signal[`di-word-dec-sum-${index}`] = add(ref(`di-${index}`), diWordDecAddend);
  signal[`di-word-dec-${index}`] = mod(add(ref(`di-word-dec-sum-${index}`), ref(`di-word-dec-carry-${index}`)), lit(2));
  signal[`di-word-dec-carry-${index + 1}`] = floor(div(add(ref(`di-word-dec-sum-${index}`), ref(`di-word-dec-carry-${index}`)), lit(2)));
  ...
  signal[`bus-offset-${index}`] = anyBits([
    ...
    andBit(ref('stosb-write'), ref(`di-${index}`)),
    andBit(ref('stosw-write'), muxBit(ref('stosw-write-high'), ref(`di-${index}`), ref(`di-inc-${index}`))),
  ]);
  signal[`bus-segment-${index}`] = anyBits([
    ...
    andBit(ref('stosb-write'), ref(`es-${index}`)),
    andBit(ref('stosw-write'), ref(`es-${index}`)),
  ]);
}
...
for (let index = 0; index < 8; index++) {
  ...
  const stoswWriteData = muxBit(ref('stosw-write-high'), ref(`ax-${index}`), ref(`ax-${index + 8}`));
  const stosWriteData = muxBit(ref('stosw-write'), ref(`ax-${index}`), stoswWriteData);
  const stringBusWriteData = muxBit(anyBits([ref('stosb-write'), ref('stosw-write')]), ordinaryBusWriteData, stosWriteData);
  signal[`bus-write-data-${index}`] = muxBit(ref('int-stack-write'), stringBusWriteData, intStackData);
...
signal['short-condition'] = anyBits([ref('opcode-jmpShort'), andBit(ref('opcode-jb'), ref('cf')), andBit(ref('opcode-jz'), ref('zf')), andBit(ref('opcode-jbe'), orBit(ref('cf'), ref('zf'))), andBit(ref('opcode-ja'), andBit(notBit(ref('cf')), notBit(ref('zf')))), andBit(ref('opcode-jnz'), notBit(ref('zf'))), andBit(ref('opcode-jl'), xorBit(ref('sf'), ref('of'))), andBit(ref('opcode-loop'), ref('cx-dec-nonzero')), andBit(ref('opcode-jcxz'), ref('cx-zero'))]);
...
signal['cmp-directed-memory-commit'] = orBit(ref('cmp-rm8-reg-memory-commit'), ref('cmp-reg-rm8-memory-commit'));
signal['cmp-rm8-immediate-memory-commit'] = ref('execute-cmp-rm8-immediate-memory');
signal['cmp-memory-commit'] = orBit(ref('cmp-directed-memory-commit'), ref('cmp-rm8-immediate-memory-commit'));
...
for (let index = 0; index < 8; index++) {
  ...
  const cmpDirectedMemoryDestination = muxBit(ref('cmp-reg-rm8-memory-commit'), ref(`busData-${index}`), ref(`saved-modrm-byte-register-value-${index}`));
  const cmpDirectedMemorySource = muxBit(ref('cmp-reg-rm8-memory-commit'), ref(`saved-modrm-byte-register-value-${index}`), ref(`busData-${index}`));
  signal[`cmp-memory-destination-${index}`] = muxBit(ref('cmp-rm8-immediate-memory-commit'), cmpDirectedMemoryDestination, ref(`busData-${index}`));
  signal[`cmp-memory-source-${index}`] = muxBit(ref('cmp-rm8-immediate-memory-commit'), cmpDirectedMemorySource, ref(`byteImmediate-${index}`));
  ...
  signal[`and-rm8-immediate-register-result-${index}`] = andBit(ref(`saved-modrm-rm-byte-register-value-${index}`), ref(`busData-${index}`));
  const groupRm8ImmediateMemoryResult = muxBit(ref('opcode-and-rm8-immediate-memory'), ref(`or-rm8-immediate-result-${index}`), ref(`and-rm8-immediate-result-${index}`));
  signal[`group-rm8-immediate-result-${index}`] = muxBit(ref('execute-and-rm8-immediate-register'), groupRm8ImmediateMemoryResult, ref(`and-rm8-immediate-register-result-${index}`));
  ...
  signal[`rol-rm8-source-${index}`] = muxBit(ref('execute-rol-rm8-cl-register'), ref(`saved-modrm-rm-byte-register-value-${index}`), ref(`modrm-rm-byte-register-value-${index}`));
  signal[`rol-rm8-result-${index}`] = anyBits(Array.from({ length: 8 }, (_, count) => andBit(equalConstant('rol-rm8-count', 3, count), ref(`rol-rm8-source-${(index - count + 8) % 8}`))));
}
...
signal['cmp-reg-rm16-register-commit'] = andBit(ref('modrm-commit'), ref('opcode-cmpRegRm'));
signal['cmp-reg-rm16-memory-commit'] = andBit(ref('capture-memory-high'), ref('opcode-cmpRegRm'));
signal['cmp-reg-rm16-commit'] = orBit(ref('cmp-reg-rm16-register-commit'), ref('cmp-reg-rm16-memory-commit'));
...
signal['group-rm8-immediate-logical-commit'] = orBit(ref('group-rm8-immediate-memory-commit'), ref('execute-and-rm8-immediate-register'));
...
signal['cmp-reg-rm16-memory-carry-0'] = lit(1);
for (let index = 0; index < WIDTH; index++) {
  ...
  signal[`cmp-reg-rm16-memory-effective-source-${index}`] = notBit(ref(`memory-live-word-${index}`));
  signal[`cmp-reg-rm16-memory-sum-${index}`] = add(ref(`memory-register-value-${index}`), ref(`cmp-reg-rm16-memory-effective-source-${index}`));
  signal[`cmp-reg-rm16-memory-result-${index}`] = mod(add(ref(`cmp-reg-rm16-memory-sum-${index}`), ref(`cmp-reg-rm16-memory-carry-${index}`)), lit(2));
  signal[`cmp-reg-rm16-memory-carry-${index + 1}`] = floor(div(add(ref(`cmp-reg-rm16-memory-sum-${index}`), ref(`cmp-reg-rm16-memory-carry-${index}`)), lit(2)));
  signal[`cmp-reg-rm16-result-${index}`] = muxBit(ref('cmp-reg-rm16-memory-commit'), ref(`modrm-sub-result-${index}`), ref(`cmp-reg-rm16-memory-result-${index}`));
...
for (const register of registers) {
  ...
  for (let index = 0; index < WIDTH; index++) {
    ...
    if (byteRegister) {
      ...
      signal[`write-and-rm8-immediate-${byteRegister.name}`] = andBit(ref('execute-and-rm8-immediate-register'), selectedBySavedModrm);
      const writeAndRm8Immediate = ref(`write-and-rm8-immediate-${byteRegister.name}`);
      ...
      const writeRolRm8Immediate = andBit(ref('execute-rol-rm8-immediate-register'), selectedBySavedModrm);
      const writeRolRm8Cl = andBit(ref('execute-rol-rm8-cl-register'), ref(`modrm-rm8-${byteRegister.name}`));
      const writeRolRm8 = orBit(writeRolRm8Immediate, writeRolRm8Cl);
      ...
      const writeModrmByte = anyBits([writeImmediateModrmByte, writeAddRm8Reg, writeAndRm8Immediate, writeSubRm8Immediate, writeSubRegRm8, writeRegisterModrmByte, writeRegisterFromRmByte, writeMemoryToRegisterByte, writeByteLogicalRm8, writeIncRm8, writeDecRm8, writeShlRm8, writeRolRm8]);
      ...
      signal[`selected-before-and-rm8-immediate-${register}-${index}`] = muxBit(writeAndRm8Immediate, registerLoadSource, ref(`and-rm8-immediate-register-result-${index % 8}`));
      const byteLogicalSource = muxBit(writeByteLogicalRm8, ref(`selected-before-and-rm8-immediate-${register}-${index}`), ref(`byte-logical-rm8-result-${index % 8}`));
...
for (let index = 0; index < WIDTH; index++) {
  ...
  const wordSteppedDi = muxBit(ref('df'), ref(`di-word-inc-${index}`), ref(`di-word-dec-${index}`));
  const selectedDiStep = muxBit(ref('finish-stosw'), steppedDi, wordSteppedDi);
  const repeatedCx = muxBit(ref('rep'), nextCx, ref(`cx-dec-${index}`));
  const finishDiString = anyBits([ref('finish-movsb'), ref('finish-stosb'), ref('finish-stosw')]);
  const movedCx = muxBit(finishDiString, nextCx, repeatedCx);
  signal[`next-si-${index}`] = muxBit(anyBits([ref('finish-movsb'), ref('finish-lodsb'), ref('finish-lodsw')]), nextSi, selectedSiStep);
  signal[`next-di-${index}`] = muxBit(finishDiString, nextDi, selectedDiStep);
...
const cmpRegRm16Carry4 = muxBit(ref('cmp-reg-rm16-memory-commit'), ref('modrm-sub-carry-4'), ref('cmp-reg-rm16-memory-carry-4'));
const cmpRegRm16Carry15 = muxBit(ref('cmp-reg-rm16-memory-commit'), ref('modrm-sub-carry-15'), ref('cmp-reg-rm16-memory-carry-15'));
const cmpRegRm16Carry16 = muxBit(ref('cmp-reg-rm16-memory-commit'), ref('modrm-sub-carry-16'), ref('cmp-reg-rm16-memory-carry-16'));
signal['cmp-reg-rm16-cf'] = notBit(cmpRegRm16Carry16);
signal['cmp-reg-rm16-pf'] = sub(lit(1), mod(add(...signalBits('cmp-reg-rm16-result', 8)), lit(2)));
signal['cmp-reg-rm16-af'] = notBit(cmpRegRm16Carry4);
signal['cmp-reg-rm16-zf'] = sub(lit(1), min(lit(1), add(...signalBits('cmp-reg-rm16-result', WIDTH))));
signal['cmp-reg-rm16-sf'] = ref('cmp-reg-rm16-result-15');
signal['cmp-reg-rm16-of'] = xorBit(cmpRegRm16Carry15, cmpRegRm16Carry16);
...
signal['update-flags'] = anyBits([andBit(ref('execute'), anyBits([ref('opcode-add'), ref('opcode-sub'), ref('opcode-cmpAxImm16'), ref('opcode-xor')])), andBit(ref('modrm-gpr-commit'), ref('opcode-modrm-xor')), ref('modrm-add-commit'), ref('modrm-sub-commit'), ref('cmp-reg-rm16-commit'), ref('memory-flag-commit'), ref('execute-add-rm8-reg'), ref('cmp-commit'), ref('execute-byte-logical-rm8'), ref('execute-inc-rm8-register'), ref('execute-dec-rm8-register'), ref('execute-shl-rm8-one-register'), ref('execute-and-rm16-immediate-register'), ref('execute-add-rm16-immediate-register'), ref('execute-cmp-rm16-immediate-register'), ref('execute-shl-rm16-one-register'), ref('execute-sar-rm16-one-register'), ref('execute-al-logical-immediate'), ref('execute-cmp-al-immediate'), ref('execute-test-rm8-immediate-memory'), ref('test-rm8-reg-commit'), ref('group-rm8-immediate-logical-commit'), ref('execute-inc'), ref('execute-dec')]);
for (const flag of ['cf', 'pf', 'af', 'zf', 'sf', 'of']) {
  ...
  signal[`selected-before-cmp-reg-rm16-${flag}`] = muxBit(ref('cmp-reg-rm16-commit'), subtractFlag, ref(`cmp-reg-rm16-${flag}`));
  const alLogicalFlag = muxBit(ref('execute-al-logical-immediate'), ref(`selected-before-cmp-reg-rm16-${flag}`), ref(`al-logical-${flag}`));
  ...
  const groupImmediateFlag = muxBit(ref('group-rm8-immediate-logical-commit'), testFlag, ref(`group-rm8-immediate-${flag}`));
