...
for (const register of registers) {
  ...
  for (let index = 0; index < WIDTH; index++) {
    ...
    const shiftSource = muxBit(ref(`write-shl-rm16-${register}`), popSource, selectedShiftSource);
