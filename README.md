...
## Current milestone: the real-mode far-pointer spine
...
The generated ALU is **376 registered one-bit nets / 59,974 CSS bytes**. The far-pointer-capable CPU is **2,468 nets / 693,488 CSS bytes** and exposes `AL/CL/DL/BL/AH/CH/DH/BH` aliases in its manifest.
...
- real-mode default-segment selection, segment-register write decode, two-byte memory and stack read/write/RMW microphases plus four-byte far-pointer reads, architectural SP ordering, `IF` update, and 20-bit physical address formation;
